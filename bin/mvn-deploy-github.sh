...
sed -e "s/CENTRAL_DEPLOY_USERNAME/${CENTRAL_DEPLOY_USERNAME}/g" ${MVN_SETTINGS_TEMPLATE_FILE} > ${MVN_SETTINGS_FILE}
sed -e "s/CENTRAL_DEPLOY_TOKEN/${CENTRAL_DEPLOY_TOKEN}/g" ${MVN_SETTINGS_TEMPLATE_FILE} > ${MVN_SETTINGS_FILE}
